( function( $ ) {
	...
	/**
	 * All of the code for your admin-facing JavaScript source should reside in
	 * this file.
	 *
	 ...
	 *
	 * Ideally, it is not considered best practice to attach more than a single
	 * DOM-ready or window-load handler for a particular page. Although scripts
	 * in the WordPress core, Plugins and Themes may be practicing this, we
