...
return sprintf(
	...
	wp_nonce_field( 'upload_archive_file' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wp_nonce_field() returns safe markup.
	wp_nonce_field( 'boldgrid_backup_restore_archive', '_wpnonce_restore' ), // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wp_nonce_field() returns safe markup.
	$encrypt_message
);
