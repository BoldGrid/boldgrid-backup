	...
	public static function format_error_info( $current_error ) {
		switch ($current_error['type']) {
			...
			case 1:
				...
				$error_info['description'] = "E_ERROR: Fatal run-time errors. These indicate errors that can not be recovered from, such as a memory allocation problem. Execution of the script is halted.";
			...
			case 2:
				$error_info = array();
				$error_info['error_code'] = $current_error['type'];
				$error_info['description'] = "E_WARNING: Run-time warnings (non-fatal errors). Execution of the script is not halted.";
				$current_error['type'] = $error_info ;
			...
			case 4:
				$error_info = array();
				$error_info['error_code'] = $current_error['type'];
				$error_info['description'] = "E_PARSE: Compile-time parse errors. Parse errors should only be generated by the parser.";
				$current_error['type'] = $error_info ;
				$current_error['additional_info'] = "This type of error may indicate a possible issue with the backup process";
				break;
			...
			case 8:
				$error_info = array();
				$error_info['error_code'] = $current_error['type'];
				$error_info['description'] = "E_NOTICE: Run-time notices. Indicate that the script encountered something that could indicate an error, but could also happen in the normal course of running a script.";
				$current_error['type'] = $error_info ;
			...
			case 8192:
				$error_info = array();
				$error_info['error_code'] = $current_error['type'];
				$error_info['description'] = "E_DEPRECATED: Run-time notices. These warnings are to provide information about code that will not work in future versions.";
				$current_error['type'] = $error_info ;
			...
			default:
				...
				$error_info = array();
				$error_info['error_code'] = $current_error['type'];
				$error_info['description'] = $unTrackedErrors[$current_error['type']][0] . ": " . $unTrackedErrors[$current_error['type']][1];
				$current_error['type'] = $error_info ;
