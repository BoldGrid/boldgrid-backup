...
class Boldgrid_Backup_Admin_Task {
	...
	public function get() {
		return [
			'id'           => $this->id,
			'type'         => $this->type,
			'created_at'   => empty( $this->date_format ) ? $this->created_at : gmdate( $this->date_format, $this->created_at ),
			'started_at'   => empty( $this->started_at ) ?
				null :
				( empty( $this->date_format ) ? $this->started_at : gmdate( $this->date_format, $this->started_at ) ),
			'completed_at' => empty( $this->completed_at ) ?
				null :
				( empty( $this->date_format ) ? $this->completed_at : gmdate( $this->date_format, $this->completed_at ) ),
