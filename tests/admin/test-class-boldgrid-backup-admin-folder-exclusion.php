...
class Test_Boldgrid_Backup_Admin_Folder_Exclusion extends WP_UnitTestCase {
	...
	public function test_is_match_archive_globs() {
		$cases = array(
			...
			array( '*.tgz', 'wp-content/archive.tgz', true ),
			array( '*.tgz', 'wp-content/archive.tar.gz', false ),
			array( '*.7z', 'wp-content/uploads/site.7z', true ),
			array( '*.7z', 'wp-content/uploads/site.zip', false ),
			array( '*.rar', 'wp-content/uploads/site.rar', true ),
